...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t_type.setText(my_app.item_data.data.get(idx).get("type").toString());
        t_info.setText(my_app.item_data.data.get(idx).get("info").toString());
    ...
    public void update_star() {
        if (my_app.item_data.stared.get(idx) == 0) {
