...
public class DetailActivity extends AppCompatActivity {
    ...
    ListView lv_more;
    ListView lv_op;
    IntentFilter ft_cart;
    MyReceiver br_dynamic;
    ShopperWidget sw_receiver;
    int idx;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft_cart.addAction(getResources().getString(R.string.dynamic_broadcast_action));
        br_dynamic = new MyReceiver();
        sw_receiver = new ShopperWidget();
        registerReceiver(br_dynamic, ft_cart);
        registerReceiver(sw_receiver, ft_cart);
        ...
        b_add_to_cart = (Button) findViewById(R.id.addcart);
        ...
        b_add_to_cart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                EventBus.getDefault().post(new MyEvent("refresh cart"));
                sendBroadcast(new Intent()
                        .setAction(getResources().getString(R.string.dynamic_broadcast_action))
                        .putExtra("itemid", iid));
    ...
    protected void onDestroy() {
        super.onDestroy();
        unregisterReceiver(br_dynamic);
        unregisterReceiver(sw_receiver);
    }
